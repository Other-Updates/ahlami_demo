...
$(function () {
    ...
    $('.daterange-locale').daterangepicker({
        ...
        opens: "left",
        ranges: {
            'Сегодн�?': [moment(), moment()],
            'Вчера': [moment().subtract('days', 1), moment().subtract('days', 1)],
            'По�?ледние 7 дней': [moment().subtract('days', 6), moment()],
            'По�?ледние 30 дней': [moment().subtract('days', 29), moment()],
            'Этот ме�?�?ц': [moment().startOf('month'), moment().endOf('month')],
            'Прошедший ме�?�?ц': [moment().subtract('month', 1).startOf('month'), moment().subtract('month', 1).endOf('month')]
        },
        locale: {
            applyLabel: 'Вперед',
            cancelLabel: 'Отмена',
            startLabel: '�?ачальна�? дата',
            endLabel: 'Конечна�? дата',
            customRangeLabel: 'Выбрать дату',
            daysOfWeek: ['В�?', 'Пн', 'Вт', 'Ср', 'Чт', 'Пт', 'Сб'],
