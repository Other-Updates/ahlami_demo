...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title">Wallet Report
    ...
    <form action="#" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8" style="display: block;">    
    	<div class="row">
            ...
            <div class="col-md-2">
            	<div class="form-group">
                    <label class="col-sm-12 col-form-label"><strong>Payment Type:</strong></label>
                    <div class="col-sm-12">
    ...
    <div class="row">
    	<div class="col-md-12">
        	<table class="table table-bordered table-striped table-hover dataTable" cellspacing="0" idth="100%" id="wallet_datatable">
        <thead>
            <tr>
                <th>S.No</th>
                <th>Customer</th>
...
<script>
    var table = $('#wallet_datatable').DataTable({
        ...
        "bLengthChange": true,
        "ajax": {
                    "url":"<?php echo $this->config->base_url();?>"+"reports/wallet_report_ajaxlist",
                    "type":"POST",
                    "data": function (data) {
        ...
        "createdRow": function(row, data, dataIndex) {
            ...
            $(row).find('td:eq(5)').attr('data-th', 'Payment Type');
    ...
    function fnExcelReport2()
    {
        ...
        var textRange;
        var j = 0;
        tab = document.getElementById('wallet_datatable'); // id of table
