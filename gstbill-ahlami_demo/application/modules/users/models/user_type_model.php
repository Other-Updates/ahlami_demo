...
class User_type_model extends CI_Model {
    ...
    private $table_name = 'scoo_user_types';
    private $user_permission_table = 'scoo_user_type_permissions';
    private $user_modules_table = 'scoo_user_modules';
    private $user_sections_table = 'scoo_user_sections';
