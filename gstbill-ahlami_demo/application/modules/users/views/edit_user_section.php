                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group has-feedback has-feedback-left">
                                ...
                                <input type="text" name="user_section[user_section_key]" id="user_section_key" class="form-controlrequired" value="<?php echo $user_section[0]['user_section_key']; ?>" placeholder="Enter User Section Key" maxlength="100">
                                <span class="error_msg"></span>
                                <div class="form-control-feedback">
                                    <i class="icon-books"></i>
                                </div>
