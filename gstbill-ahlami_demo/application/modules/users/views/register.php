...
<div class="content">
    <!-- Registration form -->
    <?php echo form_open_multipart('users/register', 'name="add_user" id="add_user"'); ?>
    <div class="row">
            ...
            <div class="panel registration-form">
                <div class="panel-body">
                    <div class="text-center">
                        ...
                        <h5 class="content-group-lg">Register New Member</h5>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group has-feedback has-feedback-left">
                                                ...
                                                <input type="text" name="member[address_line_1]" class="form-control required" placeholder="Enter Permanent Address" value="Kalyalpattinam,Tamilnadu">
                                                <span class="error_msg"></span>
                                                <div class="form-control-feedback">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group has-feedback has-feedback-left">
                                                ...
                                                <input type="text" name="member[address_line_2]" class="form-control required" placeholder="Enter Current Address" id="address_line_2" tabindex="10">
                                                <span class="error_msg"></span>
                                                <div class="form-control-feedback">
                                                    <i class="icon-location4"></i>
                                                </div>
                        ...
                        <div class="row">
                            <div class="form-groupa">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-groupa has-feedback has-feedback-left">
                    ...
                    <div class="text-right">
                        <button type="button" class="btn btn-danger" onclick="window.location = '<?php echo base_url('users/login'); ?>'" style="float:left;" title="Back to Login"><i class="icon-arrow-left13 position-left"></i> Back to Login</button>
                        <button type="submit" class="btn bg-success btn-labeled btn-labeled-right ml-10 submit" title="Create Member"><b><i class="icon-plus3"></i></b> Create Member</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="footer text-muted text-center">
        <span><?php echo $this->config->item('site_footer') ?></span>&nbsp;
        <span>Powered by <a href="http://www.f2fsolutions.co.in" target="_blank" class="powered_link">F2F Solutions</a></span>
    </div>
    <!-- /footer -->
</div>
<!-- /content area -->
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data != 0) {
                            ...
                            swal({
                                title: "Your mobile number already register as member!!!",
