        ...
        <div class="panel panel-body login-form log-bor">
            ...
            <div class="text-center">
                <?php if ($is_logo_allowed): ?>
                    <div class="icon-object border-warning-400 text-warning-400"><img src="<?php echo $theme_path; ?>/assets/images/logo.png" alt="" height="60"></i></div>
                <?php endif; ?>
                <?php if (!$is_logo_allowed): ?>
                    <div class="icon-object border-warning-400 text-warning-400" style="font-family:inherit; font-size:35px; text-transform: uppercase;"><img src="<?php echo $theme_path; ?>/assets/images/logo.png" alt="" height="80"></div>
                <?php endif; ?>
            ...
            <div class="form-group">
                <input type="hidden" name="location_info[user_location]" id="user_location" value="">
                <input type="hidden" name="location_info[latitude]" id="latitude" value="">
                <input type="hidden" name="location_info[longitude]" id="longitude" value="">
            ...
            <div class="powered_by_text">
                <a href="<?php echo base_url('users/users/forget_password') ?>" class="forget_password" style="margin-right:  119px;;">Forget Password?</a>
                <a href="<?php echo base_url('users/register') ?>" class="register">Register </a>
            </div>
            <div class="powered_by_text" style="margin-top: 10px;">
