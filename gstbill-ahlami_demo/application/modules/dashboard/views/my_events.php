            ...
            if (!empty($my_events)) {
                ...
                foreach ($my_events as $list) {
                    ...
                    <tr>
                        ...
                        <td width="10%"><?php echo (!empty($list['to_date'])) ? date('d-M-Y', strtotime($list['to_date'])) : ''; ?></td>                                          <td><a class="btn btn-primary btn-xs" onclick="window.location = '<?php echo base_url(); ?>events/events/invited_members/<?php echo $list['id']; ?>'"><?php echo (!empty($list['invited_count'])) ? $list['invited_count'] : 0; ?></a></td>
