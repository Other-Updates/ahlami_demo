                                        ...
                                        <ul class="event_tree_structure">
                                            ...
                                            if (!empty($members_tree)) {
                                                foreach ($members_tree as $city => $city_list) {
                                                    ...
                                                    $count_city = $this->members_model->get_count_variables('city', $city);
                                                    ?>
                                                    <li class="city_tree">
                                                        <div class="city_section">
                                                            <div class="checkbox">
                                                                <label>
                                                                    <input type="checkbox" name="event_city[]" class="city_item styled" value="<?php echo $city; ?>"> <?php echo $city_label[$city]; ?>
                                                                    <span class="badge" style="color:white"><?php echo $count_city; ?></span>
                                                                </label>
                                                        ...
                                                        <ul class="city_tree_structure" style="display: none;">
                                                            ...
                                                            if (!empty($city_list)) {
                                                                foreach ($city_list as $street_id => $street_list) {
                                                                    ...
                                                                    $count_street = $this->members_model->get_count_variables('street', $street_id);
                                                                    ?>
                                                                    <li class="street_tree">
                                                                        <div class="street_section">
                                                                            <div class="checkbox">
                                                                                <label>
                                                                                    <input type="checkbox" name="event_street[<?php echo $city; ?>][]" class="street_item styled" value="<?php echo $street_id; ?>"> <?php echo $streets_arr[$street_id]['street_name']; ?>
                                                                                    <span class="badge" style="color:white"><?php echo $count_street; ?></span>
                                                                                </label>
                                                                        ...
                                                                        <ul class="street_tree_structure" style="display: none;">
                                                                            ...
                                                                            if (!empty($street_list)) {
                                                                                foreach ($street_list as $group_id => $family_group) {
                                                                                    ...
                                                                                    $count_family = $this->members_model->get_count_variables('family', $group_id);
                                                                                    ?>
                                                                                    <li class="group_tree">
                                                                                        <div class="group_section">
                                                                                            <div class="checkbox">
                                                                                                <label>
                                                                                                    <input type="checkbox" name="event_group[<?php echo $city; ?>][<?php echo $street_id; ?>][]" class="group_item styled" value="<?php echo $group_id; ?>"> <?php echo $groups_arr[$group_id]['group_name']; ?>
                                                                                                    <span class="badge" style="color:white"><?php echo $count_family; ?></span>
                                                                                                </label>
                                                                                        ...
                                                                                        <ul class="group_tree_structure" style="display: none;">
                                                                                            ...
                                                                                            if (!empty($family_group)) {
                                                                                                foreach ($family_group as $member_key => $member_list) {
                                                                                                    ?>
                                                                                                    <li class="member_list"><input type="checkbox" name="event_member[<?php echo $city; ?>][<?php echo $street_id; ?>][<?php echo $group_id; ?>][]" class="member_item" value="<?php echo $member_list['id']; ?>"> <?php echo $member_list['firstname'] . ' ' . $member_list['lastname'] . '' . '-' . $member_list['relation']; ?></li>
                                                                                                    <?php
                                                                                                }
                                                                                            }
                                                                                            ?>
