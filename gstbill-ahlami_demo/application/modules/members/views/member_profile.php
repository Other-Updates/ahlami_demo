...
<div class="panel panel-flat">
    ...
    <div class="row">
        <div class="panel-body">
            <?php echo form_open_multipart('members/user/member_profile', 'name="my_profile" id="my_profile" class="form-horizontal"'); ?>
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group has-feedback has-feedback-left">
                                    <label><strong>Member_id ID:</strong></label><span class="req">*</span>
                                    <input type="text" name="user[member_id]" id="user_id" class="form-control required" value="<?php echo $user[0]['member_id']; ?>" readonly="readonly" placeholder="Enter User ID">
                                    <span class="error_msg"></span>
                                    <div class="form-control-feedback">
                                        <i class="icon-user"></i>
                                    </div>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div><span class="badge badge-primary" style="font-size: 12px;"><?php echo ucfirst($user[0]['group_name']); ?></span></div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div>
                                        <input type="text" name="user[address_line_2]" id="address" class="form-control" value="<?php echo $user[0]['address_line_2']; ?>" placeholder="Enter Address">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-md-12">
                    <button type="button" class="btn btn-danger" onclick="window.location = '<?php echo base_url() . 'members/dashboard'; ?>'" style="float:left;" title="Cancel"><i class="icon-arrow-left13 position-left"></i> Cancel</button>
