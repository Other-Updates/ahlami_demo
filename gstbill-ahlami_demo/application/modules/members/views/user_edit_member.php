...
<div class="panel panel-flat">
    ...
    <div class="panel-body">
        <?php echo form_open_multipart('members/user/edit/' . $member[0]['id'], 'name="edit_member" id="edit_member" class="form-horizontal"'); ?>
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <?php if ($chk_member_relation == 'parent') { ?>
                                <div class="form-group has-feedback adjust">
                                    <label><strong>Approved Status:</strong></label><span class="req">*</span>
                                    <select name="member[approved_status]" class="form-control required">
                                        <option value="1" <?php echo ($member[0]['approved_status'] == 1) ? 'selected' : ''; ?>>Approved</option>
                                        <option value="0" <?php echo ($member[0]['approved_status'] == 0) ? 'selected' : ''; ?>>Rejected</option>
                                        <option value="2" <?php echo ($member[0]['approved_status'] == 2) ? 'selected' : ''; ?>>Hold</option>
                                    </select>
                                    <span class="error_msg"></span>
                                </div>
                            <?php } ?>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group has-feedback has-feedback-left">
                                ...
                                <input type="text" name="member[address_line_1]" id="address_line_1" class="form-control required" value="<?php echo $member[0]['address_line_1']; ?>" placeholder="Enter Permanent Address" maxlength="150">
                                <span class="error_msg"></span>
                                <div class="form-control-feedback">
            ...
            <div class="form-group">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group has-feedback has-feedback-left">
                                ...
                                <div class="form-group col-md-6">
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="member[city]" id="city" style="width:18px; margin-top:-7px"class="form-control city" disabled="disabled" value="1" <?php echo ($member[0]['city'] == '1') ? 'checked="checked"' : ''; ?>/>Kayalpattinam &nbsp;
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="member[city]" id="others" style="width:18px; margin-top:-7px"  class="form-control city"  disabled="disabled"value="2"<?php echo ($member[0]['city'] == '2') ? 'checked="checked"' : ''; ?> />Others &nbsp;
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group has-feedback">
                                <label><strong>Family Type:</strong></label><span class="req">*</span>
        ...
        <div class="row">
            <div class="col-md-12">
                <button type="button" class="btn btn-danger" onclick="window.location = '<?php echo base_url('members/user'); ?>'" title="Cancel"style="float:left;"><i class="icon-arrow-left13 position-left"></i> Cancel</button>
