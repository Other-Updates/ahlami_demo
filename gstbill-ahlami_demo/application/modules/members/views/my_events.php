            ...
            if (!empty($my_events)) {
                ...
                foreach ($my_events as $list) {
                    ...
                    <tr>
                        ...
                        <td style="width:10%"><a class="btn btn-success btn-xs" onclick="window.location = '<?php echo base_url(); ?>members/events/accept_members/<?php echo $list['id']; ?>'"><?php echo (!empty($list['accept_count'])) ? $list['accept_count'] : 0; ?></a></td>
                        <td><a class="btn btn-danger btn-xs" onclick="window.location = '<?php echo base_url(); ?>members/events/reject_members/<?php echo $list['id']; ?>'"> <?php echo (!empty($list['reject_count'])) ? $list['reject_count'] : 0; ?></a></td>
                        <td><a class="btn btn-primary btn-xs" onclick="window.location = '<?php echo base_url(); ?>members/events/invited_members/<?php echo $list['id']; ?>'"><?php echo (!empty($list['invited_count'])) ? $list['invited_count'] : 0; ?></a></td>
                        <?php
