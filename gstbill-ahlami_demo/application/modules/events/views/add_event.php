...
<div class="panel panel-flat">
    ...
    <div class="panel-body">
        <?php echo form_open_multipart('events/add', 'name="add_event" id="add_event" class="form-horizontal"'); ?>
        <fieldset class="content-group">
            ...
            <div class="col-lg-12">
                ...
                <div class="form-group">
                    ...
                    <!--                    <div class="col-lg-2">
                                            <div class="form-group has-feedback">
                                                <label><strong>Invite Members Count:</strong></label>
                                                <div class="shapedone" style="margin-left:-8px;" >
                                                    <input type="text" class="form-control shapeone nopercent" id="mem_count" readonly="readonly">
                                                </div>
                                            </div>
                                        </div>-->
                ...
                <div class="row" style="margin-top:7px;">
                    <div class="col-md-12">
                        <button type="button" class="btn btn-danger" onclick="window.location = '<?php echo base_url('events'); ?>'" style="float:left;" title="Cancel"><i class="icon-arrow-left13 position-left"></i> Cancel</button>
