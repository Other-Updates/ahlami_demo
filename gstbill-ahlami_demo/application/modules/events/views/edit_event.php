...
<style type="text/css">
    ...
    .shapeone {
        ...
        border-radius: 145px;
        background: linear-gradient(to left, #8c2891 2%, #da65e0 100%);
        position:relative;
        margin:0 auto;
    }
    .nopercent {
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-xs-3">
                            ...
                            <select name="event[approved_status]" class="form-control required">
                                <option value="1" <?php echo ($event[0]['approved_status'] == 1) ? 'selected="selected"' : ''; ?>>Approved</option>
                                <option value="0" <?php echo ($event[0]['approved_status'] == 0) ? 'selected="selected"' : ''; ?>>Rejected</option>
                                <option value="2" <?php echo ($event[0]['approved_status'] == 2) ? 'selected="selected"' : ''; ?>>Pending</option>
                            </select>
                            <span class="error_msg"></span>
                        </div>
                    </div>
                                                        ...
                                                        <div class="city_section">
                                                            <div class="checkbox">
                                                                <label class="city_label">
                                                                    <input type="checkbox" name="event_city[]" class="city_item" value="<?php echo $city; ?>" <?php echo $city_checked; ?>> <?php echo $city_label[$city]; ?>
                                                                </label>
                                                                        ...
                                                                        <div class="street_section">
                                                                            <div class="checkbox">
                                                                                <label class="street_label">
                                                                                    <input type="checkbox" name="event_street[<?php echo $city; ?>][]" class="street_item" value="<?php echo $street_id; ?>" <?php echo $street_checked; ?>> <?php echo $streets_arr[$street_id]['street_name']; ?>
                                                                                </label>
                                                                                        ...
                                                                                        <div class="group_section">
                                                                                            <div class="checkbox">
                                                                                                <label class="group_label">
                                                                                                    <input type="checkbox" name="event_group[<?php echo $city; ?>][<?php echo $street_id; ?>][]" class="group_item" value="<?php echo $group_id; ?>" <?php echo $group_checked; ?>> <?php echo $groups_arr[$group_id]['group_name']; ?>
                                                                                                </label>
                                                                                        ...
                                                                                        <ul class="group_tree_structure" style="display: none;">
                                                                                            ...
                                                                                            if (!empty($family_group)) {
                                                                                                foreach ($family_group as $member_key => $member_list) {
                                                                                                    ...
                                                                                                    ?>
                                                                                                    <li class="member_list"><input type="checkbox" name="event_member[<?php echo $city; ?>][<?php echo $street_id; ?>][<?php echo $group_id; ?>][]" class="member_item" value="<?php echo $member_list['id']; ?>" <?php echo $member_checked; ?>> <?php echo $member_list['firstname'] . ' ' . $member_list['lastname'] . '' . '-' . $member_list['relation']; ?></li>
                                                                                                    <?php
                                                                                                }
                                                                                            }
                                                                                            ?>
                                        ...
                                        if (isset($event_invitations) && !empty($event_invitations)) {
                                            ...
                                            foreach ($event_invitations as $value) {
                                                ...
                                                <tr>
                                                    ...
                                                    ?>
                                                    <td class="center">
                                                        <a href="javascript:void(0);"><img src="<?php echo $invitation_url; ?>" class="delete<?php echo $value['id']; ?>" style="width: 100%; height: 150px; border: 1px #ccc solid; padding: 3px;" title="<?php echo $value['file_name']; ?>" ></a>
                                                    </td>
                                                    <td class="center">
                            ...
                            foreach ($event_dynamic_fields as $field_id => $fieldInfo) {
                                ...
                                switch ($fieldType) {
                                    ...
                                    case 'file':
                                        ...
                                        $field_text .= '<div class="col-xs-4 dynamic_file_section">';
                                    ...
                                    case 'select':
                                        ...
                                        if (!empty($fieldOptions)) {
                                            foreach ($fieldOptions as $option) {
                                                $selected = (is_array($fieldValue_arr) && in_array($option['label'], $fieldValue_arr)) ? 'selected="selected"' : '';
                                                $option_text .= '<option value="' . $option['label'] . '" ' . $selected . '>' . $option['label'] . '</option>';
                                            }
                                        }
                                        $field_text .= '<div class="col-xs-4">';
                                        $field_text .= '<div class="form-group has-feedback has-feedback-left">';
                                    ...
                                    case 'checkbox-group':
                                        ...
                                        if (!empty($fieldOptions)) {
                                            foreach ($fieldOptions as $option) {
                                                $checked = (is_array($fieldValue_arr) && in_array($option['label'], $fieldValue_arr)) ? 'checked="checked"' : '';
                                                ...
                                                $option_text .= '<div class="checkbox"><label><input type="checkbox" name="dynamic[' . $fieldID . '][]" value="' . $option['label'] . '" ' . $checked . '>' . $option['label'] . '</label></div>';
                                            }
                                        }
                                    ...
                                    case 'radio-group':
                                        ...
                                        if (!empty($fieldOptions)) {
                                            foreach ($fieldOptions as $option) {
                                                $checked = ($option['label'] == $fieldValue) ? 'checked="checked"' : '';
//                                                $option_text .= '<div class="radio"><label><input type="radio" name="dynamic[' . $fieldID . ']" value="' . $option['value'] . '" ' . $checked . '>' . $option['label'] . '</label></div>';
                                                $option_text .= '<div class="radio"><label><input type="radio" name="dynamic[' . $fieldID . ']" value="' . $option['label'] . '" ' . $checked . '>' . $option['label'] . '</label></div>';
                                            }
                                        }
                                        $field_text .= '<input type="hidden" name="dynamic[' . $fieldID . ']" value="">';
                                        $field_text .= '<div class="col-xs-4">';
    ...
    $(document).ready(function () {
        ...
        $('.submit').click(function () {
            ...
            $('.required').each(function () {
                ...
                if (this_val == '' && !$(this).hasClass('dynamic_file')) {
                    $(this).closest('div.form-group').find('.error_msg').text('This field is required').slideDown('500').css('display', 'inline-block');
                    m++;
                } else if (this_val == '' && $(this).hasClass('dynamic_file')) {
                    dynamic_table_length = Number($(this).closest('div.dynamic_file_section').find('.dynamic_file_table tbody tr').length);
                    if (dynamic_table_length == 0) {
                        $(this).closest('div.form-group').find('.error_msg').text('This field is required').slideDown('500').css('display', 'inline-block');
                        m++;
                    } else {
                        $(this).closest('div.form-group').find('.error_msg').text('').slideUp('500');
